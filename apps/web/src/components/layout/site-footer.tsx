      ...
      <div className="page-shell grid gap-4 text-sm sm:grid-cols-[1fr_auto] sm:gap-8">
        <div>
          <div className="flex items-center justify-between gap-3 sm:block">
            <p className="font-black text-black">ViralTimes</p>
            <p className="text-[0.65rem] text-black/30 sm:mt-4 sm:text-[0.68rem]">© 2026 ViralTimes</p>
          </div>
          <p className="mt-2 hidden max-w-xl text-xs leading-5 text-black/45 sm:block">
            게시물·영상·음원·이미지의 저작권은 각 원저작자와 권리자에게 있습니다.
            ViralTimes는 출처와 확산 맥락을 기록하며, 권리 침해 문의는 확인 후 조치합니다.
          </p>
          <details className="mt-2 text-[0.68rem] leading-5 text-black/40 sm:hidden">
            <summary className="font-bold">저작권 안내</summary>
            <p className="mt-1">콘텐츠 저작권은 각 원저작자와 권리자에게 있으며, ViralTimes는 사전 편집·서비스 구성에 대한 권리만 보유합니다.</p>
          </details>
        </div>
        <nav className={`hide-scrollbar flex content-start gap-4 overflow-x-auto whitespace-nowrap pt-3 text-[0.68rem] font-bold text-black/55 sm:grid sm:grid-cols-2 sm:gap-2 sm:overflow-visible sm:pt-0 sm:text-xs ${embedded ? "" : "border-t border-black/5 sm:border-0"}`}>
          ...
          <a
            ...
            href="https://github.com/iftype/viraltimes"
            target="_blank"
            rel="noreferrer"
          >

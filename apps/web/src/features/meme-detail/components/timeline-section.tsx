  ...
  return (
    <section className="border-y border-black/5 bg-white py-14 sm:py-20">
      <div className="page-shell"><div className="mx-auto max-w-3xl">
        <div className="flex items-start justify-between gap-4"><div><p className="text-xs font-black text-[#25a9a4]">TIMELINE</p><h2 className="mt-1 text-2xl font-black tracking-[-0.04em]">시작부터 유행까지</h2></div><ProposalButton memeId={meme.id} memeTitle={meme.title} section="timeline" /></div>

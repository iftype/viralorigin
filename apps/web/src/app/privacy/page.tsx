...
const sections = [
  ...
  {
    title: "4. 방문 분석",
    body: "서비스 개선을 위해 Vercel Web Analytics로 방문 시각, 페이지 경로, 유입 경로, 국가·지역 수준의 위치, 기기·운영체제·브라우저 종류 같은 집계 정보를 처리합니다. 밈 인지도 퀴즈는 브라우저에 생성한 무작위 세션 ID와 카드별 응답(알아요·몰라요·상세 열람·설명 도움 여부)을 저장합니다. 밈별 최근 사용 신호도 같은 무작위 세션 ID, 응답 날짜와 봤어요·못 봤어요 선택을 저장하며 같은 날의 마지막 선택만 남깁니다. 이름, 이메일, 계정 정보는 이 기록과 연결하지 않고 댓글·제보 본문이나 이메일 주소를 분석 이벤트에 넣지 않습니다.",
  },
  {
    title: "5. AI 보조 편집",
